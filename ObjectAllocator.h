...
private:
	...
	void AddToFreeList(char * byteArray);
	void *GetObjectFromFreeList(const char * label);
	bool CheckValidPointer(void * address);
	bool IsInFreeList(void * address) const;
	void RemoveFromFreeList(void * object);
